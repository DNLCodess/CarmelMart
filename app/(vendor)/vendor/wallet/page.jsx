    ...
    <div className="space-y-6">
      ...
      <div className="bg-primary rounded-2xl p-6 text-white relative overflow-hidden">
        ...
        <div className="relative">
          ...
          {isLoading ? (
            ...
            <p className="text-4xl font-extrabold mt-1 mb-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 px-5 py-4">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">
            From delivered orders not yet paid out
          </p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 px-5 py-4">
          <p className="text-xs text-gray-500 dark:text-gray-400 font-semibold uppercase tracking-wide">
          ...
          <p className="text-xl font-extrabold text-green-600 dark:text-green-400 mt-1">
            ₦{totalEarned.toLocaleString()}
          </p>
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">
            All-time credits to your wallet
          </p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 px-5 py-4 col-span-2 sm:col-span-1">
          ...
          <p className="text-xl font-extrabold text-primary dark:text-white mt-1">
            1–2 Business Days
          </p>
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">
      ...
      {showWithdraw && (
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 space-y-4">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Funds are transferred to your registered bank account. Processing
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        {[
          {
            label: "Total Earned",
            value: isLoading ? "—" : `₦${totalEarned.toLocaleString()}`,
          ...
          <div
            key={label}
            className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-4 text-center"
          >
          ...
          <div className="divide-y divide-gray-50 dark:divide-gray-700">
            {transactions.map((t) => (
              <div key={t.id} className="flex items-center gap-4 px-5 py-4">
                ...
                <p
                  className={`font-bold text-sm shrink-0 ${t.type === "credit" ? "text-green-600" : "text-red-500"}`}
                >
                  {t.type === "credit" ? "+" : "−"}₦
