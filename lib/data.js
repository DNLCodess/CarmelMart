...
export const featuredProducts = [
  ...
  },
  {
    ...
    reviews: 203,
    image:
      "https://images.unsplash.com/photo-1557438159-51eec7a6c9e8?w=600&q=80",
    badge: "Best Seller",
...
export const topVendors = [
  {
    name: "Fashion Hub NG",
    description: "Premium African fashion & accessories",
    products: 245,
    rating: 4.9,
    sales: "5.2K",
    image:
  ...
  },
  {
    ...
    description: "Quality furniture & home decor",
    products: 312,
    rating: 4.9,
    sales: "7.1K",
    image:
  ...
  {
    name: "Beauty Palace",
    description: "Authentic beauty & skincare",
    products: 156,
    rating: 5.0,
    sales: "4.5K",
    image:
...
export const footerLinks = {
  shop: [
    ...
    { name: "Flash Sale",    href: "/shop?sort=flash_sale"},
  ...
  company: [
    ...
    { name: "Careers",       href: "/help#careers"       },
    { name: "Press & Media", href: "/help#press"         },
    { name: "Partnerships",  href: "/help#partnerships"  },
    { name: "Blog",          href: "/help#blog"          },
  ],
  vendors: [
    { name: "Start Selling",  href: "/register"             },
    { name: "Seller Guide",   href: "/help#seller-guide"    },
    { name: "Pricing & Fees", href: "/help#seller-fees"     },
    { name: "Seller Support", href: "/help#seller-support"  },
    { name: "Seller Portal",  href: "/vendor/dashboard"     },
  ],
};
